...
(function() {
    ...
    function wa(a, b, c) {
        if (a && b && c) {
            ...
            if ("undefined"!==typeof Blob && new Blob) {
                for (var g = a.replace(/^data:[a-z/]*;base64,/, ""), g = atob(g), h = new ArrayBuffer(g.length), p = new Uint8Array(h), k = 0;k < g.length;k++)
                    p[k] = g.charCodeAt(k);
                b = new Blob([h], {type:"image/" + b});
                try {
    ...
    var t = !!document.createElement("canvas").getContext, ha = {
        ...
        theme1:{
            Chart:{colorSet:"colorSet1"},Title:{fontFamily:t?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":"calibri",fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:10},Axis:{
                    titleFontSize:26,titleFontColor:"#666666",titleFontFamily:t?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":"calibri",labelFontFamily:t?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":
                                                                                                                                                                  "calibri",labelFontSize:18,labelFontColor:"grey",tickColor:"#BBBBBB",tickThickness:2,gridThickness:2,gridColor:"#BBBBBB",lineThickness:2,lineColor:"#BBBBBB"
                },Legend:{verticalAlign:"bottom",horizontalAlign:"center",fontFamily:t?"monospace, sans-serif,arial black":"calibri"},DataSeries:{indexLabelFontColor:"grey",indexLabelFontFamily:t?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":"calibri",indexLabelFontSize:18,indexLabelLineThickness:1}
        },theme2:{
            Chart:{colorSet:"colorSet2"},Title:{
                    fontFamily:"impact, charcoal, arial black, sans-serif",
                    fontSize:32,fontColor:"#333333",verticalAlign:"top",margin:10
                },Axis:{titleFontSize:22,titleFontColor:"rgb(98,98,98)",titleFontFamily:t?"monospace, sans-serif,arial black":"arial",titleFontWeight:"bold",labelFontFamily:t?"monospace, Courier New, Courier":"arial",labelFontSize:16,labelFontColor:"grey",labelFontWeight:"bold",tickColor:"grey",tickThickness:2,gridThickness:2,gridColor:"grey",lineThickness:0},Legend:{
                    verticalAlign:"bottom",horizontalAlign:"center",fontFamily:t?"monospace, sans-serif,arial black":
                                                                               "arial"
            ...
            Chart:{colorSet:"colorSet1"},Title:{fontFamily:t?"Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif":"calibri",fontSize:32,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:10},Axis:{
                    titleFontSize:22,titleFontColor:"rgb(98,98,98)",titleFontFamily:t?"Verdana, Geneva, Calibri, sans-serif":
                                                                                    "calibri",labelFontFamily:t?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":"calibri",labelFontSize:18,labelFontColor:"grey",tickColor:"grey",tickThickness:2,gridThickness:2,gridColor:"grey",lineThickness:2,lineColor:"grey"
                },Legend:{verticalAlign:"bottom",horizontalAlign:"center",fontFamily:t?"monospace, sans-serif,arial black":"calibri"},DataSeries:{
                    bevelEnabled:!0,indexLabelFontColor:"grey",indexLabelFontFamily:t?"Candara, Optima, Calibri, Verdana, Geneva, sans-serif":"calibri",indexLabelFontSize:18,
                    indexLabelLineColor:"lightgrey",indexLabelLineThickness:2
                }
        }
    }, B = {numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")}, sa = {}, R = null, ya = function() {
        ...
        for (var t = 0;h && t < h.length;t++)
            if (b=h[t],"."===b && 0 > p)
                ...
                0 > p?(k.push(b),"#"===b || "0"===b?r++:","===b && q++):(l.push(b),"#"!==b && "0"!==
                                                                                              b || m++)
            }
        ...
        a = (b[1] + "").split("");
        g && "0"===g[0]&&g.shift();
        for (t=n=h=m=p=0;0 < k.length;)
            if (b=k.pop(),"#"===b || "0"===b)if (p++,p===r) {
                var u = g, g = [];
                if ("0"===b)
                    for (b=r - m - (u?u.length:0);0 < b;)
                        u.unshift("0"),b--;
                for (;0 < u.length;)
                    c=u.pop() + c,t++,0===t % n && (h===q && 0 < u.length) && (c=f + c);
                d&&(c="-" + c)
            }
            else
                0 < g.length?(c=g.pop() + c,m++,t++):"0"===b && (c="0" + c,m++,t++),0===t % n && (h===
                                                                                                  q && 0 < g.length) && (c=f + c);
            else
                "E"!==b[0] && "e"!==b[0] || "0"!==b[b.length - 1] || !/[eE][+-]*[0]+/.test(b)?","===b?(h++,n=t,t=0,0 < g.length && (c=f + c)):c=1 < b.length && ('"'===b[0] && '"'===b[b.length - 1] || "'"===b[0] && "'"===b[b.length - 1])?b.slice(1, b.length - 1) + c:b + c:(b=0 > s?b.replace("+", "").replace("-", ""):b.replace("-", ""),c+=b.replace(/[0]+/, function(a) {
                    return L(s, a.length)
                }));
        d = "";
        for (f=!1;0 < l.length;)
    ...
    v.prototype._updateOptions = function() {
        ...
        this._options.zoomEnabled?(this._zoomButton || (S(this._zoomButton=document.createElement("button")),N(this, this._zoomButton, "pan"),this._toolBar.appendChild(this._zoomButton),E(this._zoomButton, "click", function() {
            a.zoomEnabled?
            (a.zoomEnabled=!1,a.panEnabled=!0,N(a, a._zoomButton, "zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,N(a, a._zoomButton, "pan"));
            a.render()
            ...
            a._toolTip.hide();
            a.zoomEnabled || a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,N(a, a._zoomButton, "pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):
        ...
        this._menuButton?this.exportEnabled?ka(this._menuButton):S(this._menuButton):this.exportEnabled && t && (this._menuButton=document.createElement("button"),
                                                                                     N(this, this._menuButton, "menu"),this._toolBar.appendChild(this._menuButton),E(this._menuButton, "click", function() {
    ...
    v.prototype._updateSize = function() {
        ...
        return this.canvas.width!==a * I || this.canvas.height!==b * I?(da(this.canvas, a, b),da(this.overlaidCanvas, a, b),da(this._eventManager.ghostCanvas, a, b),!0):!1
    };
    v.prototype._initialize = function() {
        ...
        for (var a = 0, b = 0;b < this._options.data.length;b++)
            if (a++,!this._options.data[b].type || 0 <= v._supportedChartTypes.indexOf(this._options.data[b].type)) {
                var c =
                    new Q(this, this._options.data[b], this.theme, a - 1, ++this._eventManager.lastObjectId);
    ...
    v.prototype._processMultiseriesPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0;g < a.dataSeriesIndexes.length;g++) {
                var h =
                    this.data[a.dataSeriesIndexes[g]], p = 0, k = !1, l = !1;
                ...
                if (h.dataPoints[p].x && h.dataPoints[p].x.getTime ||
                ...
                for (p=0;p < h.dataPoints.length;p++) {
                    ...
                    if (!(d < r) || k) {
                        ...
                        if (d > m && !l)
                            ...
                            continue;
                        h.dataPoints[p].label&&(a.axisX.labels[d]=
    ...
    v.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], h = [], p = 0;p < a.dataSeriesIndexes.length;p++) {
                var k = this.data[a.dataSeriesIndexes[p]], l = 0, r = !1, m =
                    !1;
                ...
                for (l=0;l < k.dataPoints.length;l++) {
                    ...
                    if (!(d < q) || r) {
                        ...
                        d < c.viewPortMin&&(c.viewPortMin=
                                            d);
                        d > c.viewPortMax&&(c.viewPortMax=d);
                        null!==e&&(a.yTotals[d]=(a.yTotals[d]?a.yTotals[d]:0) + Math.abs(e),0 <= e?g[d]=g[d]?g[d] + e:e:h[d]=h[d]?h[d] + e:e)
                    }
                }
            ...
            for (l in h)
                isNaN(l)||(a=h[l],a < b.min && (b.min=a),a > b.max && (b.max=a),l < c.viewPortMin || l > c.viewPortMax || (a < b.viewPortMin &&
            ...
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, h = !1, p = [], k = 0;k < a.dataSeriesIndexes.length;k++) {
                ...
                for (r=0;r < l.dataPoints.length;r++) {
                    ...
                    if (!(d < n) || m) {
                        ...
                        d < c.viewPortMin&&(c.viewPortMin=d);
                        d > c.viewPortMax&&(c.viewPortMax=d);
                        null!==e&&(a.yTotals[d]=(a.yTotals[d]?a.yTotals[d]:0) + Math.abs(e),0 <= e?g=!0:h=!0,p[d]=p[d]?p[d] + Math.abs(e):Math.abs(e))
                    }
                }
                this.plotInfo.axisXValueType =
                l.xValueType=f?"dateTime":"number"
            }
            g && !h?(b.max=99,b.min=1):g && h?(b.max=99,b.min=-99):!g && h && (b.max=-1,b.min=-99);
            b.viewPortMin = b.min;
            b.viewPortMax = b.max;
            a.dataPointYSums = p
        }
    ...
    v.prototype._processMultiYPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, h = !1, p = 0;p < a.dataSeriesIndexes.length;p++) {
                ...
                for (l=0;l < k.dataPoints.length;l++) {
                    ...
                    (h=!0,d=k.dataPoints[l].x.getTime()):d = k.dataPoints[l].x;
    ...
    v.prototype._plotAreaMouseUp = function(a, b) {
        ...
        if (("normal"===
            ...
            if (2 < Math.abs(e)) {
                ...
                !0;
                this.zoomEnabled && "none"===this._zoomButton.style.display&&(ka(this._zoomButton, this._resetButton),N(this, this._zoomButton, "pan"),N(this, this._resetButton, "reset"))
            }
        }
        this.isDrag = !1
    };
    ...
    v.prototype.renderLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0;e < a.dataSeriesIndexes.length;e++) {
                ...
                b.beginPath();
                if (0 < h.length) {
                    for (var q = !1, l = 0;l < h.length;l++)
                        if (r=h[l].x.getTime?h[l].x.getTime():h[l].x,!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax))
                            if ("number"!==typeof h[l].y)
                                ...
                                m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (h[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                ...
                                k || q?(b.beginPath(),b.moveTo(r, m),t && (c.beginPath(),c.moveTo(r, m)),q=k=!1):(b.lineTo(r, m),t &&
    ...
    v.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0;e < a.dataSeriesIndexes.length;e++) {
                ...
                if (0 < h.length) {
                    for (var q = !1, l = 0;l < h.length;l++)
                        if (r=h[l].getTime?h[l].x.getTime():h[l].x,!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax))
                            if ("number"!==typeof h[l].y)
                                0 < l && (b.stroke(),t && c.stroke()),q=!0;
                            else {
                                var n = m;
                                r = a.axisX.conversionParameters.reference +
                                    a.axisX.conversionParameters.pixelPerUnit * (r - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (h[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                ...
                                k || q?(b.beginPath(),b.moveTo(r, m),t && (c.beginPath(),c.moveTo(r, m)),q=k=!1):(b.lineTo(r, n),t && c.lineTo(r, n),b.lineTo(r, m),t && c.lineTo(r, m),0 == l % 500 &&
                                                                                                                                                                                        (b.stroke(),b.beginPath(),b.moveTo(r, m),t && (c.stroke(),c.beginPath(),c.moveTo(r, m))));
                                if (0 < h[l].markerSize || 0 < g.markerSize)
                                    n=g.getMarkerProperties(l, r, m, b),d.push(n),s=A(s),t && d.push({x:r,y:m,ctx:c,type:n.type,size:n.size,color:s,borderColor:s,borderThickness:n.borderThickness});
        ...
        function b(a) {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0;b < a.length - 3;b+=3)
                    c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y),t && d.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y),0 < b && 0===b % 3E3 && (c.stroke(),c.beginPath(),c.moveTo(a[b + 3].x,
                                                                                                                                                                                                                                                                    a[b + 3].y),t && (d.stroke(),d.beginPath(),d.moveTo(a[b + 3].x, a[b + 3].y)));
                c.stroke();
                t&&d.stroke()
            }
        }
    ...
    var G = function(a, b, c, d, e, f, g, h, p, k, l, r, m) {
        ...
        a.globalAlpha = 1;
        0 < g&&(m=0===g %
                      2?0:0.5,a.beginPath(),a.lineWidth=g,a.strokeStyle=h,a.moveTo(b, c),a.rect(b - m, c - m, d - b + 2 * m, e - c + 2 * m),a.stroke());
        a.restore();
        ...
        !0===k&&(a.save(),a.beginPath(),a.moveTo(b, e),a.lineTo(b + q, e - q),a.lineTo(d - q, e - q),a.lineTo(d, e),a.closePath(),g=a.createLinearGradient((d +
        ...
        !0===r&&(a.save(),a.beginPath(),a.moveTo(d, c),a.lineTo(d - q, c + q),a.lineTo(d - q, e - q),a.lineTo(d, e),g=a.createLinearGradient(d -
    ...
    v.prototype.renderColumn = function(a) {
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = 0, f, g, h, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, e = Math.min(0.15 *
                                                                                                                                                                                                                    this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, k = a.axisX.dataInfo.minDiff, l = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(k) / a.plotType.totalDataSeries) << 0;
            l > e?l=e:Infinity===k?l=e:1 > l && (l=1);
            b.save();
            ...
            for (d=0;d < a.dataSeriesIndexes.length;d++) {
                var k = a.dataSeriesIndexes[d],
                    r = this.data[k], m = r.dataPoints;
                if (0 < m.length)
                    for (var q = 5 < l && r.bevelEnabled?!0:!1, e = 0;e < m.length;e++)
                        if (m[e].getTime?h=m[e].x.getTime():h=m[e].x,!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number"===typeof m[e].y) {
                            ...
                            g = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (m[e].y - a.axisY.conversionParameters.minimum) + 0.5 <<
                                0;
                            ...
                            c = r.dataPointIds[e];
                            this._eventManager.objectMap[c] = {id:c,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:f,y1:g,x2:n,y2:s};
                            c = A(c);
    ...
    v.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c =
                null, d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = 0.15 * this.width << 0, k = a.axisX.dataInfo.minDiff, l = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(k) / a.plotType.plotUnits.length) << 0;
            l > g?l=g:Infinity===k?l=g:1 > l && (l=1);
            b.save();
            t&&this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
                ...
                if (0 < q.length) {
                    ...
                    for (g=0;g < q.length;g++)
                        if (c=q[g].x.getTime?q[g].x.getTime():q[g].x,!(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number"===typeof q[g].y) {
                            ...
                            var s = d - a.plotType.plotUnits.length * l / 2 + a.index * l << 0, C = s + l << 0, u;
                            if (0 <= q[g].y) {
                                var x = e[c]?e[c]:0;
                                h-=x;
                                u = p - x;
                                ...
                                x=f[c]?f[c]:0,u=h + x,h=p + x,f[c]=x + (u - h);
                            ...
                            this._eventManager.objectMap[c] = {
                                ...
                                dataSeriesIndex:r,dataPointIndex:g,x1:s,y1:h,x2:C,y2:u
                            };
                            c = A(c);
                            t&&G(this._eventManager.ghostCtx, s, h, C, u, c, 0, null, !1, !1, !1, !1);
                            (q[g].indexLabel || m.indexLabel)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:q[g],dataSeries:m,point:{x:d,y:0 <= q[g].y?h:u},direction:0 <= q[g].y?1:-1,bounds:{x1:s,y1:Math.min(h, u),x2:C,y2:Math.max(h, u)},color:c})
                        }
                }
            }
            b.restore();
                    ...
                    for (var n = 5 < l && m.bevelEnabled?!0:!1, g = 0;g < q.length;g++)
                        if (c=q[g].x.getTime?q[g].x.getTime():q[g].x,!(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                            ...
                            if (0 <= q[g].y) {
                                ...
                                x=f[c]?f[c]:0,u=h + x,h=p + x,f[c]=x + (u -
                                                                        h);
                            c = q[g].color?q[g].color:m._colorSet[g % m._colorSet.length];
                            G(b, s, h, C, u, c, 0, null, n && 0 <= q[g].y, 0 > q[g].y && n, !1, !1, m.fillOpacity);
                            c = m.dataPointIds[g];
                            this._eventManager.objectMap[c] = {id:c,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:g,x1:s,y1:h,x2:C,y2:u};
                            c = A(c);
                            t&&G(this._eventManager.ghostCtx, s, h, C, u, c, 0, null, !1, !1, !1, !1);
                            (q[g].indexLabel || m.indexLabel)&&this._indexLabels.push({
                                                                                          chartType:"stackedColumn100",dataPoint:q[g],dataSeries:m,point:{x:d,y:0 <= q[g].y?h:u},direction:0 <= q[g].y?1:-1,
    ...
    v.prototype.renderBar = function(a) {
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = 0, f, g, h, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                                                                                          (0 - a.axisY.conversionParameters.minimum) << 0, e = Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, k = a.axisX.dataInfo.minDiff, l = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(k) / a.plotType.totalDataSeries) << 0;
            l > e?l=e:Infinity===k?l=e:1 > l && (l=1);
            b.save();
            t&&this._eventManager.ghostCtx.save();
            b.beginPath();
                ...
                if (0 < m.length) {
                    ...
                    for (e=0;e < m.length;e++)
                        if (m[e].getTime?h=m[e].x.getTime():h=m[e].x,!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number"===typeof m[e].y) {
                            ...
                            c = r.dataPointIds[e];
                            this._eventManager.objectMap[c] = {id:c,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:s,y1:g,x2:f,y2:n};
                            c = A(c);
    ...
    v.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c =
                null, d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = 0.15 * this.height << 0, k = a.axisX.dataInfo.minDiff, l = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(k) / a.plotType.plotUnits.length) << 0;
            l > g?l=g:Infinity===k?l=g:1 > l && (l=1);
            b.save();
            t&&this._eventManager.ghostCtx.save();
            b.beginPath();
                    ...
                    for (g=0;g < q.length;g++)
                        if (c=q[g].x.getTime?q[g].x.getTime():q[g].x,!(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number"===typeof q[g].y) {
                            ...
                            if (0 <= q[g].y) {
                                ...
                                x=f[c]?f[c]:0,u=h - x,h=p - x,f[c]=x + (h - u);
                            c = q[g].color?q[g].color:m._colorSet[g % m._colorSet.length];
                            G(b, u, s, h, C, c, 0, null, n, !1, !1, !1, m.fillOpacity);
                            c = m.dataPointIds[g];
                            this._eventManager.objectMap[c] = {
                                id:c,objectType:"dataPoint",dataSeriesIndex:r,
                                dataPointIndex:g,x1:u,y1:s,x2:h,y2:C
                            };
                            c = A(c);
                            t&&G(this._eventManager.ghostCtx, u, s, h, C, c, 0, null, !1, !1, !1, !1);
                            this._indexLabels.push({chartType:"stackedBar",dataPoint:q[g],dataSeries:m,point:{x:0 <= q[g].y?h:u,y:d},direction:0 <= q[g].y?1:-1,bounds:{x1:Math.min(u, h),y1:s,x2:Math.max(u, h),y2:C},color:c})
                        }
                }
            }
            b.restore();
            ...
            a = Math.max(p, a.axisX.boundingRect.x2);
            return{
                source:b,dest:this.plotArea.ctx,animationCallback:y.xScaleAnimation,easingFunction:y.easing.easeOutQuart,
                animationBase:a
            }
        }
    };
                    ...
                    for (g=0;g < q.length;g++)
                        if (c=q[g].x.getTime?q[g].x.getTime():q[g].x,!(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                            ...
                            if (0 <= q[g].y) {
                                ...
                                x=f[c]?f[c]:0,u=h - x,h=p - x,f[c]=x + (h -
                                                                        u);
                            c = q[g].color?q[g].color:m._colorSet[g % m._colorSet.length];
                            G(b, u, s, h, C, c, 0, null, n, !1, !1, !1, m.fillOpacity);
                            c = m.dataPointIds[g];
                            this._eventManager.objectMap[c] = {id:c,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:g,x1:u,y1:s,x2:h,y2:C};
                            c = A(c);
                            t&&G(this._eventManager.ghostCtx, u, s, h, C, c, 0, null, !1, !1, !1, !1);
                            this._indexLabels.push({chartType:"stackedBar100",dataPoint:q[g],dataSeries:m,point:{x:0 <= q[g].y?h:u,y:d},direction:0 <= q[g].y?1:-1,bounds:{x1:Math.min(u, h),y1:s,x2:Math.max(u, h),y2:C},color:c})
                        }
                }
            }
            b.restore();
    ...
    v.prototype.renderArea = function(a) {
        function b() {
            x&&(0 < k.lineThickness && c.stroke(),0 >= a.axisY.minimum && 0 <= a.axisY.maximum?u=C:0 > a.axisY.maximum?u=f.y1:0 < a.axisY.minimum && (u=e.y2),c.lineTo(q, u),c.lineTo(x.x, u),c.closePath(),c.globalAlpha=k.fillOpacity,c.fill(),c.globalAlpha=1,t && (d.lineTo(q, u),
                                                                                                                                                                                                                                                                 d.lineTo(x.x, u),d.closePath(),d.fill()),c.beginPath(),c.moveTo(q, n),d.beginPath(),d.moveTo(q, n),x={x:q,y:n})
        }
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h=0;h < a.dataSeriesIndexes.length;h++) {
                var p = a.dataSeriesIndexes[h],
                    k = this.data[p], l = k.dataPoints, g = k.id;
                this._eventManager.objectMap[g] = {objectType:"dataSeries",dataSeriesIndex:p};
                g = A(g);
                d.fillStyle = g;
                var g = [], r = !0, m = 0, q, n, s, C = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0, u, x = null;
                if (0 < l.length) {
                    var w = k._colorSet[m % k._colorSet.length];
                    c.fillStyle = w;
                    c.strokeStyle = w;
                    c.lineWidth = k.lineThickness;
                    for (var F = !0;m < l.length;m++)
                        if (s=l[m].x.getTime?l[m].x.getTime():l[m].x,!(s < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number"!==typeof l[m].y)
                                ...
                                r || F?(c.beginPath(),c.moveTo(q, n),x={x:q,y:n},t && (d.beginPath(),d.moveTo(q, n)),F=r=!1):(c.lineTo(q, n),t && d.lineTo(q, n),0 == m % 250 && b());
                                var H = k.dataPointIds[m];
                                this._eventManager.objectMap[H] =
                                {id:H,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:m,x1:q,y1:n};
                                0!==l[m].markerSize && (0 < l[m].markerSize || 0 < k.markerSize)&&(s=k.getMarkerProperties(m, q, n, c),g.push(s),H=A(H),t && g.push({x:q,y:n,ctx:d,type:s.type,size:s.size,color:H,borderColor:H,borderThickness:s.borderThickness}));
                                (l[m].indexLabel || k.indexLabel)&&this._indexLabels.push({chartType:"area",dataPoint:l[m],dataSeries:k,point:{x:q,y:n},direction:0 <= l[m].y?1:-1,color:w})
                            }
                    b();
                    K.drawMarkers(g)
                }
    ...
    v.prototype.renderSplineArea = function(a) {
        function b() {
            ...
            if (0 < b.length) {
                ...
                0 >= a.axisY.minimum &&
                0 <= a.axisY.maximum?s=n:0 > a.axisY.maximum?s=f.y1:0 < a.axisY.minimum && (s=e.y2);
                C = {x:b[0].x,y:b[0].y};
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h=0;h < a.dataSeriesIndexes.length;h++) {
                ...
                g = A(g);
                d.fillStyle = g;
                var g = [], r = 0, m, q, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0, s, C = null, u = [];
                if (0 < l.length) {
                    color = k._colorSet[r %
                                        k._colorSet.length];
                    c.fillStyle = color;
                    c.strokeStyle = color;
                    for (c.lineWidth=k.lineThickness;r < l.length;r++)
                        if (m=l[r].x.getTime?l[r].x.getTime():l[r].x,!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))
                            if ("number"!==typeof l[r].y)
                                ...
                                q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (l[r].y - a.axisY.conversionParameters.minimum) +
                                    0.5 << 0;
                                ...
                                (l[r].indexLabel || k.indexLabel)&&this._indexLabels.push({
                                                                                              chartType:"splineArea",dataPoint:l[r],dataSeries:k,point:{
                                        x:m,
                                        y:q
                                    },direction:0 <= l[r].y?1:-1,color:color
                                                                                          })
                            }
                    b();
                    K.drawMarkers(g)
    ...
    v.prototype.renderStepArea = function(a) {
        function b() {
            x&&(0 < k.lineThickness && c.stroke(),0 >= a.axisY.minimum && 0 <= a.axisY.maximum?u=C:0 > a.axisY.maximum?u=f.y1:0 < a.axisY.minimum && (u=e.y2),c.lineTo(q, u),c.lineTo(x.x, u),c.closePath(),c.globalAlpha=k.fillOpacity,c.fill(),
            c.globalAlpha=1,t && (d.lineTo(q, u),d.lineTo(x.x, u),d.closePath(),d.fill()),c.beginPath(),c.moveTo(q, n),d.beginPath(),d.moveTo(q, n),x={x:q,y:n})
        }
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = this._eventManager.ghostCtx, e = a.axisX.lineCoordinates, f = a.axisY.lineCoordinates, g = [], h = this.plotArea;
            ...
            for (h=0;h < a.dataSeriesIndexes.length;h++) {
                var p =
                    a.dataSeriesIndexes[h], k = this.data[p], l = k.dataPoints, g = k.id;
                this._eventManager.objectMap[g] = {objectType:"dataSeries",dataSeriesIndex:p};
                g = A(g);
                d.fillStyle = g;
                var g = [], r = !0, m = 0, q, n, s, C = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0, u, x = null, w = !1;
                if (0 < l.length) {
                    var F = k._colorSet[m % k._colorSet.length];
                    c.fillStyle = F;
                    c.strokeStyle = F;
                    for (c.lineWidth=k.lineThickness;m < l.length;m++)
    ...
    v.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = [], e = this.plotArea, f = [], g = [], h = 0, p, k, l, r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) <<
                                                                                         0, m = this._eventManager.ghostCtx;
            t&&m.beginPath();
            b.save();
            t&&m.save();
            b.beginPath();
            ...
            for (e=0;e < a.dataSeriesIndexes.length;e++) {
                ...
                for (h=0;h < s.length;h++)
                    q=s[h].x.getTime?s[h].x.getTime():s[h].x,n.dataPointIndexes[q]=h,xValuePresent[q] || (g.push(q),xValuePresent[q]=!0);
                g.sort(ra)
            }
            for (e=0;e < a.dataSeriesIndexes.length;e++) {
                var q =
                    a.dataSeriesIndexes[e], n = this.data[q], s = n.dataPoints, C = !0, u = [], h = n.id;
                ...
                if (0 < g.length) {
                    ...
                    for (h=0;h < g.length;h++) {
                        l = g[h];
                        var x = null, x = 0 <= n.dataPointIndexes[l]?s[n.dataPointIndexes[l]]:{x:l,y:0};
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number"===typeof x.y) {
                            ...
                            f[l] = r - k;
                            if (C)
                                b.beginPath(),b.moveTo(p, k),t && (m.beginPath(),m.moveTo(p, k)),C=!1;
                            else if (b.lineTo(p, k),t && m.lineTo(p, k),0 == h % 250) {
                            ...
                            if (0 <= n.dataPointIndexes[l]) {
                                ...
                                this._eventManager.objectMap[H] = {id:H,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:n.dataPointIndexes[l],x1:p,y1:k}
                            }
                            0 <= n.dataPointIndexes[l] && 0!==x.markerSize && (0 < x.markerSize || 0 < n.markerSize)&&(l=n.getMarkerProperties(h, p, k, b),d.push(l),markerColor=A(H),t && d.push({
                                                                                                                                                                                                      x:p,y:k,ctx:m,type:l.type,size:l.size,color:markerColor,
                                                                                                                                                                                                      borderColor:markerColor,borderThickness:l.borderThickness
                                                                                                                                                                                                  }));
                            (x.indexLabel || n.indexLabel)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:x,dataSeries:n,point:{x:p,y:k},direction:0 <= s[h].y?1:-1,color:c})
                        }
                    }
                    for (0 < n.lineThickness && b.stroke();0 < u.length;)
                        v=u.pop(),b.lineTo(v.x, v.y),t && m.lineTo(v.x, v.y);
                    b.closePath();
                    b.globalAlpha = n.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    v.prototype.renderStackedArea100 = function(a) {
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = [], f = [], g = [], h = 0, p, k, l, r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, m = 0.15 * this.width << 0, q = a.axisX.dataInfo.minDiff,
                q = 0.9 * d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(q) << 0, n = this._eventManager.ghostCtx;
            b.save();
            t&&n.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (d=0;d < a.dataSeriesIndexes.length;d++) {
                ...
                for (h=0;h < u.length;h++)
                    s=u[h].x.getTime?u[h].x.getTime():u[h].x,C.dataPointIndexes[s]=h,xValuePresent[s] || (g.push(s),xValuePresent[s]=
                                                                                                                    !0);
                g.sort(ra)
            }
            for (d=0;d < a.dataSeriesIndexes.length;d++) {
                ...
                if (0 < g.length) {
                    ...
                    for (h=0;h < g.length;h++) {
                        l = g[h];
                        var v = null, v = 0 <= C.dataPointIndexes[l]?u[C.dataPointIndexes[l]]:{x:l,y:0};
                        if (!(l < a.axisX.dataInfo.viewPortMin ||
                              l > a.axisX.dataInfo.viewPortMax) && "number"===typeof v.y) {
                            ...
                            f[l] = r - k;
                            if (x)
                                b.beginPath(),b.moveTo(p, k),t && (n.beginPath(),n.moveTo(p, k)),x=!1;
                            else if (b.lineTo(p,
                                              k),t && n.lineTo(p, k),0 == h % 250) {
                            ...
                            if (0 <= C.dataPointIndexes[l]) {
                                ...
                                this._eventManager.objectMap[z] = {id:z,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:C.dataPointIndexes[l],x1:p,y1:k}
                            }
                            0 <=
                            C.dataPointIndexes[l] && 0!==v.markerSize && (0 < v.markerSize || 0 < C.markerSize)&&(l=C.getMarkerProperties(h, p, k, b),e.push(l),markerColor=A(z),t && e.push({x:p,y:k,ctx:n,type:l.type,size:l.size,color:markerColor,borderColor:markerColor,borderThickness:l.borderThickness}));
                            (v.indexLabel || C.indexLabel)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:v,dataSeries:C,point:{x:p,y:k},direction:0 <= u[h].y?1:-1,color:c})
                        }
                    }
                    for (0 < C.lineThickness && b.stroke();0 < w.length;)
                        B=w.pop(),b.lineTo(B.x, B.y),t && n.lineTo(B.x,
                                                                   B.y);
                    b.closePath();
                    b.globalAlpha = C.fillOpacity;
                    b.fill();
    ...
    v.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= c)) {
            var d = this.plotArea, e = 0, f, g, h =
                0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff, c = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(e) / c) << 0;
            b.save();
            t&&this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            b.clip();
            t&&(this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height),this._eventManager.ghostCtx.clip());
            for (var p = -Infinity, k = Infinity, l = 0;l < a.dataSeriesIndexes.length;l++)
                for (var r = a.dataSeriesIndexes[l], m = this.data[r], q = m.dataPoints, n = 0, e = 0;e < q.length;e++)
                    f=q[e].getTime?f=q[e].x.getTime():
                      f=q[e].x,f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined"===typeof q[e].z || (n=q[e].z,n > p && (p=n),n < k && (k=n));
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), l = 0;l < a.dataSeriesIndexes.length;l++)
                if (r=a.dataSeriesIndexes[l],m=this.data[r],q=m.dataPoints,1 == q.length && (c=h),1 > c?c=1:c > h && (c=h),0 < q.length)
                    for (b.strokeStyle="#4572A7 ",e=0;e < q.length;e++)
                        if (f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) &&
                                                                       "number"===typeof q[e].y) {
                            ...
                            this._eventManager.objectMap[u] = {id:u,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:e,x1:f,y1:g,size:v};
                            v = A(u);
    ...
    v.prototype.renderScatter = function(a) {
        var b = a.targetCanvasCtx || this.plotArea.ctx, c = a.dataSeriesIndexes.length;
        if (!(0 >= c)) {
            var d = this.plotArea, e = 0, f, g, h = 0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff, c = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(e) / c) << 0;
            b.save();
            t&&this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (var p = 0;p < a.dataSeriesIndexes.length;p++) {
                ...
                if (0 < r.length) {
                    ...
                    for (var m = 0, q = 0, e = 0;e < r.length;e++)
                        if (f=r[e].getTime?f=r[e].x.getTime():f=r[e].x,!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number"===typeof r[e].y) {
                            ...
                            Math.sqrt((m - f) * (m - f) + (q - g) * (q - g)) < Math.min(n.size, 5) && r.length > Math.min(this.plotArea.width, this.plotArea.height)||(m=l.dataPointIds[e],this._eventManager.objectMap[m]={
                                id:m,objectType:"dataPoint",dataSeriesIndex:k,
                                dataPointIndex:e,x1:f,y1:g
                            },m=A(m),t && K.drawMarker(n.x, n.y, this._eventManager.ghostCtx, n.type, n.size, m, m, n.borderThickness),(r[e].indexLabel || l.indexLabel) && this._indexLabels.push({chartType:"scatter",dataPoint:r[e],dataSeries:l,point:{x:f,y:g},direction:1,color:null}),m=f,q=g)
                        }
                }
            }
            b.restore();
    ...
    v.prototype.renderCandlestick = function(a) {
        var b =
            a.targetCanvasCtx || this.plotArea.ctx, c = this._eventManager.ghostCtx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, d = this.plotArea, e = 0, f, g, h, p, k, l, e = 0.015 * this.width;
            f = a.axisX.dataInfo.minDiff;
            var r = 0.7 * d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(f) << 0;
            ...
            for (var m = 0;m < a.dataSeriesIndexes.length;m++) {
                var q = a.dataSeriesIndexes[m],
                    n = this.data[q], s = n.dataPoints;
                if (0 < s.length)
                    for (var v = 5 < r && n.bevelEnabled?!0:!1, e = 0;e < s.length;e++)
                        if (s[e].getTime?l=s[e].x.getTime():l=s[e].x,!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && null!==s[e].y && s[e].y.length && "number"===typeof s[e].y[0] && "number"===typeof s[e].y[1] && "number"===typeof s[e].y[2] && "number"===typeof s[e].y[3]) {
                            ...
                            h = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (s[e].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            k = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (s[e].y[3] - a.axisY.conversionParameters.minimum) +
                                0.5 << 0;
                            var u = f - r / 2 << 0, x = u + r << 0, d = s[e].color?s[e].color:n._colorSet[0], w = Math.round(Math.max(1, 0.15 * r)), F = 0===w % 2?0:0.5, H = n.dataPointIds[e];
                            this._eventManager.objectMap[H] = {id:H,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:e,x1:u,y1:g,x2:x,y2:h,x3:f,y3:p,x4:f,y4:k,borderThickness:w,color:d};
                            b.strokeStyle = d;
                            b.beginPath();
                            b.lineWidth = w;
                            c.lineWidth = Math.max(w, 4);
                            "candlestick"===n.type?(b.moveTo(f - F, h),b.lineTo(f - F, Math.min(g, k)),b.stroke(),b.moveTo(f - F, Math.max(g, k)),b.lineTo(f - F, p),b.stroke(),
                            G(b, u, Math.min(g, k), x, Math.max(g, k), s[e].y[0] <= s[e].y[3]?n.risingColor:d, w, d, v, v, !1, !1, n.fillOpacity),t && (d=A(H),c.strokeStyle=d,c.moveTo(f - F, h),c.lineTo(f - F, Math.min(g, k)),c.stroke(),c.moveTo(f - F, Math.max(g, k)),c.lineTo(f - F, p),c.stroke(),G(c, u, Math.min(g, k), x, Math.max(g, k), d, 0, null, !1, !1, !1, !1))):"ohlc"===n.type && (b.moveTo(f - F, h),b.lineTo(f - F, p),b.stroke(),b.beginPath(),b.moveTo(f, g),b.lineTo(u, g),b.stroke(),b.beginPath(),b.moveTo(f, k),b.lineTo(x, k),b.stroke(),t && (d=A(H),c.strokeStyle=d,c.moveTo(f -
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             F, h),c.lineTo(f - F, p),c.stroke(),c.beginPath(),c.moveTo(f, g),c.lineTo(u, g),c.stroke(),c.beginPath(),c.moveTo(f, k),c.lineTo(x, k),c.stroke()));
                            (s[e].indexLabel || n.indexLabel)&&this._indexLabels.push({chartType:n.type,dataPoint:s[e],dataSeries:n,point:{x:u + (x - u) / 2,y:h},direction:1,bounds:{x1:u,y1:Math.min(h, p),x2:x,y2:Math.max(h, p)},color:d})
                        }
            }
            b.restore();
            t&&c.restore();
    ...
    v.prototype.renderRangeColumn =
    function(a) {
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = 0, f, g, e = 0.03 * this.width;
            f = a.axisX.dataInfo.minDiff;
            var h = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(f) / a.plotType.totalDataSeries) << 0;
            h > e?h=e:Infinity===f?h=e:1 > h && (h=1);
            b.save();
            t&&this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (var p = 0;p < a.dataSeriesIndexes.length;p++) {
                var k = a.dataSeriesIndexes[p], l = this.data[k], r = l.dataPoints;
                if (0 < r.length)
                    for (var m = 5 < h && l.bevelEnabled?!0:!1, e = 0;e < r.length;e++)
                        if (r[e].getTime?g=r[e].x.getTime():g=r[e].x,!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null!==r[e].y && r[e].y.length && "number"===typeof r[e].y[0] && "number"===typeof r[e].y[1]) {
                            c = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (g - a.axisX.conversionParameters.minimum) + 0.5 <<
                                0;
                            ...
                            f = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (r[e].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            this._eventManager.objectMap[s] = {
                                id:s,
                                objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:q,y1:d,x2:n,y2:f
                            };
                            ...
                            if (r[e].indexLabel || l.indexLabel)
                                this._indexLabels.push({chartType:"rangeColumn",dataPoint:r[e],dataSeries:l,indexKeyword:0,point:{x:q + (n - q) / 2,y:r[e].y[1] >= r[e].y[0]?f:d},direction:r[e].y[1] >= r[e].y[0]?-1:1,bounds:{x1:q,y1:Math.min(d, f),x2:n,y2:Math.max(d, f)},color:c}),this._indexLabels.push({
    ...
    v.prototype.renderRangeBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                d = this.plotArea, e = 0, f, g, h, e = Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0;
            f = a.axisX.dataInfo.minDiff;
            ...
            for (var k = 0;k < a.dataSeriesIndexes.length;k++) {
                var l =
                    a.dataSeriesIndexes[k], r = this.data[l], m = r.dataPoints;
                if (0 < m.length) {
                    var q = 5 < p && r.bevelEnabled?!0:!1;
                    b.strokeStyle = "#4572A7 ";
                    for (e=0;e < m.length;e++)
                        if (m[e].getTime?h=m[e].x.getTime():h=m[e].x,!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null!==m[e].y && m[e].y.length && "number"===typeof m[e].y[0] && "number"===typeof m[e].y[1]) {
                            ...
                            f = a.axisY.conversionParameters.reference +
                                a.axisY.conversionParameters.pixelPerUnit * (m[e].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                            g = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (h - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            this._eventManager.objectMap[c] = {
                                id:c,objectType:"dataPoint",
                                dataSeriesIndex:l,dataPointIndex:e,x1:d,y1:g,x2:f,y2:n
                            };
                            c = A(c);
                            t&&G(this._eventManager.ghostCtx, d, g, f, n, c, 0, null, !1, !1, !1, !1);
                            if (m[e].indexLabel || r.indexLabel)
                                this._indexLabels.push({chartType:"rangeBar",dataPoint:m[e],dataSeries:r,indexKeyword:0,point:{x:m[e].y[1] >= m[e].y[0]?d:f,y:g + (n - g) / 2},direction:m[e].y[1] >= m[e].y[0]?-1:1,bounds:{x1:Math.min(d, f),y1:g,x2:Math.max(d, f),y2:n},color:c}),this._indexLabels.push({
                                                                                                                                                                                                                                                                                                                 chartType:"rangeBar",dataPoint:m[e],dataSeries:r,indexKeyword:1,point:{
                                        x:m[e].y[1] >=
                                          m[e].y[0]?f:d,y:g + (n - g) / 2
                                    },direction:m[e].y[1] >= m[e].y[0]?1:-1,bounds:{x1:Math.min(d, f),y1:g,x2:Math.max(d, f),y2:n},color:c
                                                                                                                                                                                                                                                                                                             })
                        }
                }
            }
    ...
    v.prototype.renderRangeArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.clip();
            t&&(d.beginPath(),d.rect(f.x1, f.y1,
                                     f.width, f.height),d.clip());
            for (f=0;f < a.dataSeriesIndexes.length;f++) {
                ...
                if (0 < k.length) {
                    ...
                    for (var x = !0;r < k.length;r++)
                        if (s=k[r].x.getTime?k[r].x.getTime():k[r].x,!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if (null!==
                                k[r].y && k[r].y.length && "number"===typeof k[r].y[0] && "number"===typeof k[r].y[1]) {
                                ...
                                q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[r].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[r].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                l || x?(c.beginPath(),
                                c.moveTo(m, q),v={x:m,y:q},g=[],g.push({x:m,y:n}),t && (d.beginPath(),d.moveTo(m, q)),x=l=!1):(c.lineTo(m, q),g.push({x:m,y:n}),t && d.lineTo(m, q),0 == r % 250 && b());
                                s = p.dataPointIds[r];
                                this._eventManager.objectMap[s] = {id:s,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:r,x1:m,y1:q,y2:n};
                                if (0!==k[r].markerSize && (0 < k[r].markerSize || 0 < p.markerSize)) {
                                    var w = p.getMarkerProperties(r, m, n, c);
                                    e.push(w);
                                    var F = A(s);
                                    t&&e.push({x:m,y:n,ctx:d,type:w.type,size:w.size,color:F,borderColor:F,borderThickness:w.borderThickness});
                                    w = p.getMarkerProperties(r, m, q, c);
                                    e.push(w);
                                    F = A(s);
                                    t&&e.push({x:m,y:q,ctx:d,type:w.type,size:w.size,color:F,borderColor:F,borderThickness:w.borderThickness})
                                }
                                if (k[r].indexLabel || p.indexLabel)
                                    this._indexLabels.push({chartType:"rangeArea",dataPoint:k[r],dataSeries:p,indexKeyword:0,point:{x:m,y:q},direction:k[r].y[0] <= k[r].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeArea",dataPoint:k[r],dataSeries:p,indexKeyword:1,point:{x:m,y:n},direction:k[r].y[0] <= k[r].y[1]?1:-1,color:u})
                            }
                            else
                                b(),
                                x=!0;
    ...
    v.prototype.renderRangeSplineArea = function(a) {
        function b() {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0;b < a.length - 3;b+=3)
                    c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y),t && d.bezierCurveTo(a[b + 1].x,
                ...
                if (0 < h.lineThickness) {
                    ...
                    for (b=a.length - 1;2 < b;b-=3)
                        c.bezierCurveTo(a[b - 1].x, a[b - 1].y,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f=0;f < a.dataSeriesIndexes.length;f++) {
                var g = a.dataSeriesIndexes[f],
                    h = this.data[g], p = h.dataPoints, e = h.id;
                ...
                if (0 < p.length) {
                    ...
                    c.fillStyle = color;
                    c.strokeStyle = color;
                    for (c.lineWidth=h.lineThickness;k < p.length;k++)
                        if (l=p[k].x.getTime?p[k].x.getTime():p[k].x,!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax))
                            if (null!==p[k].y && p[k].y.length && "number"===typeof p[k].y[0] && "number"===typeof p[k].y[1]) {
                                l =
                                a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (l - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[k].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[k].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                var s = h.dataPointIds[k];
                                this._eventManager.objectMap[s] = {
                                    id:s,objectType:"dataPoint",dataSeriesIndex:g,
                                    dataPointIndex:k,x1:l,y1:r,y2:m
                                };
                                q[q.length] = {x:l,y:r};
                                n[n.length] = {x:l,y:m};
                                if (0!==p[k].markerSize && (0 < p[k].markerSize || 0 < h.markerSize)) {
                                    ...
                                    e.push(v);
                                    var u = A(s);
                                    t&&e.push({x:l,y:r,ctx:d,type:v.type,size:v.size,color:u,borderColor:u,borderThickness:v.borderThickness});
                                ...
                                if (p[k].indexLabel || h.indexLabel)
                                    this._indexLabels.push({
                                                               chartType:"splineArea",
                                                               dataPoint:p[k],dataSeries:h,indexKeyword:0,point:{x:l,y:r},direction:p[k].y[0] <= p[k].y[1]?-1:1,color:color
                                                           }),this._indexLabels.push({chartType:"splineArea",dataPoint:p[k],dataSeries:h,indexKeyword:1,point:{x:l,y:m},direction:p[k].y[0] <= p[k].y[1]?1:-1,color:color})
                            }
                            else
                                0 < k&&(b(),q=[],n=[]);
                    b();
    ...
    function(a) {
        function b() {
            if (k && l) {
                ...
                for (z=0;z < l.length;z++) {
                    var e = l[z], g = k.dataPointIds[z], f = {id:g,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0};
                    n.push(f);
                    ...
                    f.indexLabelLineColor = e.indexLabelLineColor?e.indexLabelLineColor:
                                            k.indexLabelLineColor?k.indexLabelLineColor:e.color?e.color:k._colorSet[z % k._colorSet.length];
                    ...
                    f.indexLabelFontSize = e.indexLabelFontSize?
                                           e.indexLabelFontSize:k.indexLabelFontSize;
                    ...
                    f.indexLabelMaxWidth = e.indexLabelMaxWidth?e.indexLabelMaxWidth:k.indexLabelMaxWidth?k.indexLabelMaxWidth:0.33 * m.width;
                    f.indexLabelWrap = "undefined"!==typeof e.indexLabelWrap?e.indexLabelWrap:k.indexLabelWrap;
                    f.startAngle = 0===
                                   z?k.startAngle?k.startAngle / 180 * Math.PI:0:n[z - 1].endAngle;
                ...
                for (z=0;z < l.length;z++)
                    f=n[(c + z) % l.length],1 <
                                            a && (f.midAngle > Math.PI / 2 - u && f.midAngle < Math.PI / 2 + u) && (e <= a / 2 && !h?(f.hemisphere="right",e++):(f.hemisphere="left",h=!0));
                h = !1;
                for (z=0;z < l.length;z++)
                    f=n[(d + z) % l.length],1 < b && (f.midAngle > 3 * Math.PI / 2 - u && f.midAngle < 3 * Math.PI / 2 + u) && (g <= b / 2 && !h?(f.hemisphere="left",g++):(f.hemisphere="right",h=!0))
            }
        }
        function c(a) {
            ...
            for (b=0;b < l.length;b++) {
                ...
                if (d > c) {
                    ...
                    else if (0 < Math.abs(n[b].center.x - w.x) || 0 < Math.abs(n[b].center.y - w.y))
                    ...
                    pa(p.plotArea.ctx, n[b].center, n[b].radius, l[b].color?
                                                                 l[b].color:k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity)
                }
            }
            a = p.plotArea.ctx;
            a.fillStyle = "black";
        ...
        function d(a, b) {
            var c = a.indexLabelTextBlock.x,
                d = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height / 2, e = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height / 2, f = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height / 2, g = b.indexLabelTextBlock.x + b.indexLabelTextBlock.width, l = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
            return a.indexLabelTextBlock.x + a.indexLabelTextBlock.width < b.indexLabelTextBlock.x - r || c > g + r || d > l + r || e < f - r?!1:!0
        }
        function e(a, b) {
            var c = 0, c = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height / 2, d = a.indexLabelTextBlock.y +
                                                                                           a.indexLabelTextBlock.height / 2, e = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height / 2, f = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
        ...
        function g(a, b) {
            ...
            if (0 <= a && a < l.length) {
                var m = n[a];
                if (0 > b && m.indexLabelTextBlock.y < d || 0 < b && m.indexLabelTextBlock.y > k)
                    return 0;
                var h = b, p = 0, r = 0, r = p=p=0;
                0 > h?m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 > d && m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 + h < d && (h=-(d - (m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 + h))):m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2 < d && m.indexLabelTextBlock.y + m.indexLabelTextBlock.height /
                                                                                                                                                                                                                                                                                                                                      2 + h > k && (h=m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2 + h - k);
                ...
                h = p < r?h - m.indexLabelTextBlock.y:0;
                d = null;
                ...
                p = f(a);
                k = d=0;
                0 > h?(k="right"===m.hemisphere?r:p,c=h,null!==k && (r=-h,h=m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 - (n[k].indexLabelTextBlock.y + n[k].indexLabelTextBlock.height / 2),h - r < s && (d=-r,q++,k=g(k, d),+k.toFixed(v) > +d.toFixed(v) &&
                                                                                                                                                                                                                                             (c=h > s?-(h - s):-(r - (k - d)))))):0 < h && (k="right"===m.hemisphere?p:r,c=h,null!==k && (r=h,h=n[k].indexLabelTextBlock.y - n[k].indexLabelTextBlock.height / 2 - (m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2),h - r < s && (d=r,q++,k=g(k, d),+k.toFixed(v) < +d.toFixed(v) && (c=h > s?h - s:r - (d - k)))));
                c&&(h=m.indexLabelTextBlock.y + c,d=0,d="right"===m.hemisphere?w.x + Math.sqrt(Math.pow(B, 2) - Math.pow(h - w.y, 2)):w.x - Math.sqrt(Math.pow(B, 2) - Math.pow(h - w.y, 2)),m.midAngle > Math.PI / 2 - u && m.midAngle < Math.PI / 2 + u?(k=(a - 1 + n.length) % n.length,
                                                                                                                                                                                             k=n[k],r=n[(a + 1 + n.length) % n.length],"left"===m.hemisphere && "right"===k.hemisphere && d > k.indexLabelTextBlock.x?d=k.indexLabelTextBlock.x - 15:"right"===m.hemisphere && ("left"===r.hemisphere && d < r.indexLabelTextBlock.x) && (d=r.indexLabelTextBlock.x + 15)):m.midAngle > 3 * Math.PI / 2 - u && m.midAngle < 3 * Math.PI / 2 + u && (k=(a - 1 + n.length) % n.length,k=n[k],r=n[(a + 1 + n.length) % n.length],"right"===m.hemisphere && "left"===k.hemisphere && d < k.indexLabelTextBlock.x?d=k.indexLabelTextBlock.x + 15:"left"===m.hemisphere && ("right"===r.hemisphere &&
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      d > r.indexLabelTextBlock.x) && (d=r.indexLabelTextBlock.x - 15)),m.indexLabelTextBlock.y=h,m.indexLabelTextBlock.x=d,m.indexLabelAngle=Math.atan2(m.indexLabelTextBlock.y - w.y, m.indexLabelTextBlock.x - w.x))
            }
            return c
        }
        function h() {
            ...
            for (var b = 0, c = a=0, a = 0;10 > a && (1 > a || 0 < c);a++) {
                ...
                if ("inside"!==k.indexLabelPlacement) {
                    ...
                    for (var q, u, b = 0;b < l.length;b++) {
                        ...
                        if (null!==z) {
                            ...
                            var D = 0, D = e(q, u) - s;
                            if (0 > D) {
                                for (var A = u=q=0;A < l.length;A++)
                                    A!==b && n[A].hemisphere===h.hemisphere&&(n[A].indexLabelTextBlock.y < h.indexLabelTextBlock.y?q++:u++);
                                A = D / (q + u || 1) * u;
                                q = -1 * (D - A);
                                var E = u=0;
                                "right"===h.hemisphere?(u=g(b, A),q=-1 * (D - u),E=g(z, q),+E.toFixed(v) < +q.toFixed(v) && +u.toFixed(v) <= +A.toFixed(v) && g(b, -(q - E))):(u=g(z, A),q=-1 *
                                                                                                                                                                                           (D - u),E=g(b, q),+E.toFixed(v) < +q.toFixed(v) && +u.toFixed(v) <= +A.toFixed(v) && g(z, -(q - E)))
                            }
                        }
                    }
                }
                    ...
                    for (b=0;b < l.length;b++)
                        h=n[b],B="pie"===k.type?0.7 * y:0.8 * y,D=w.x + B * Math.cos(h.midAngle),A=w.y + B * Math.sin(h.midAngle),h.indexLabelTextBlock.x=D,h.indexLabelTextBlock.y=A;
                for (b=0;b < l.length;b++)
                    h=n[b],D=h.indexLabelTextBlock.measureText(),0!==D.height && 0!==D.width && (D=D=0,"right"===h.hemisphere?(D=m.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + r),D*=-1):D=m.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width -
                ...
                z = h=-1;
                for (A=E=0;A < l.length;A++)
                    if (q=n[A],q.indexLabelText) {
                        var G = f(A);
                        null!==G&&(u=n[G],D=0,D=e(q, u),0 > D && d(q, u)?(0 > h && (h=A),G!==h && (z=G),E+=-D):0 < E && (b(E, h, z),z=h=-1,E=0))
                    }
                0 < E&&b(E, h, z)
            }
        }
        var p = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            for (var k = this.data[a.dataSeriesIndexes[0]], l = k.dataPoints, r = 10, m = this.plotArea, q = 0, n = [], s = 2, t = 1.3, u = 20 / 180 * Math.PI, v = 6, w = {x:(m.x2 + m.x1) / 2,y:(m.y2 + m.y1) / 2}, y = "inside"===k.indexLabelPlacement?0.95 * Math.min(m.width, m.height) / 2:0.8 * Math.min(m.width, m.height) / 2, B = y * t, A = 0, z = 0;z < l.length;z++)
                A+=Math.abs(l[z].y);
            0!==A&&(this.pieDoughnutClickHandler=function(a) {
                ...
                for (b=0;b < l.length;b++) {
                    ...
                    d > c&&pa(p.plotArea.ctx, n[b].center,
                              n[b].radius, f, k.type, c, d, k.fillOpacity);
                    if (e)
                        break
                }
            }, function() {
    ...
    aa.prototype.unRegisterSpace = function(a, b) {
        "top"===a?this._topOccupied-=b.height:"bottom"===a?this._bottomOccupied-=b.height:
                                              "left"===a?this._leftOccupied-=b.width:"right"===a && (this._rightOccupied-=b.width)
    };
    ...
    ba.prototype.render = function() {
        if (this.text) {
            var a = this.chart.layoutManager.getFreeSpace(), b = 0, c = 0, d = 0, e = 0, f = 0, g, h;
            ...
            var f = new J(this.ctx, {
                              fontSize:this.fontSize,fontFamily:this.fontFamily,fontColor:this.fontColor,fontStyle:this.fontStyle,fontWeight:this.fontWeight,horizontalAlign:this.horizontalAlign,verticalAlign:this.verticalAlign,borderColor:this.borderColor,
            ...
            "top"===this.verticalAlign || "bottom"===this.verticalAlign?("top"===this.verticalAlign?(c=this.margin,h="top"):"bottom"===this.verticalAlign && (c=a.y2 - this.margin - p.height,h="bottom"),"left"===this.horizontalAlign?b=a.x1 + this.margin:"center"===this.horizontalAlign?b=a.x1 + (e / 2 - p.width / 2) + this.margin:
                                                                                                                                                                                                                                                             "right"===this.horizontalAlign && (b=a.x2 - this.margin - p.width),g=this.horizontalAlign,this.width=p.width,this.height=p.height):"center"===this.verticalAlign && ("left"===this.horizontalAlign?(b=a.x1 + this.margin,c=a.y2 - this.margin - (e / 2 - p.width / 2),d=-90,h="left",this.width=p.height,this.height=p.width):"right"===this.horizontalAlign?(b=a.x2 - this.margin,c=a.y1 + this.margin + (e / 2 - p.width / 2),d=90,h="right",this.width=p.height,this.height=p.width):"center"===this.horizontalAlign && (c=a.y1 + (a.height / 2 - p.height /
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  2),b=a.x1 + (a.width / 2 - p.width / 2),h="center",this.width=p.width,this.height=p.height),g="center");
            f.x = b;
            f.y = c;
            f.angle = d;
            f.horizontalAlign = g;
            f.render(!0);
            this.chart.layoutManager.registerSpace(h, {width:this.width + 2 * this.margin,height:this.height + 2 * this.margin});
    ...
    ga.prototype.render = function() {
        ...
        for (var p = 0;p < this.dataSeries.length;p++) {
            var k = this.dataSeries[p], l = k.legendMarkerType?k.legendMarkerType:"line"!==k.type && "stepLine"!==k.type && "spline"!==k.type && "scatter"!==k.type && "bubble"!==k.type || !k.markerType?Q.getDefaultLegendMarker(k.type):k.markerType, r = k.legendText?k.legendText:
                                                                                                                                                                                                                                                             k.name, m = k.legendMarkerColor?k.legendMarkerColor:k.markerColor?k.markerColor:k._colorSet[0], q = k.markerSize || "line"!==k.type && "stepLine"!==k.type && "spline"!==k.type?0.6 * this.lineHeight:0;
            if ("pie"!==k.type && "doughnut"!==k.type && "funnel"!==k.type)
                l={markerType:l,markerColor:m,text:r,textBlock:null,chartType:k.type,markerSize:q,lineColor:k._colorSet[0],dataSeriesIndex:k.index,dataPointIndex:null},g.push(l);
            else
                for (var n = 0;n < k.dataPoints.length;n++)
                    q=k.dataPoints[n],l=q.legendMarkerType?q.legendMarkerType:
        ...
        if (0 <
            ...
            for (p=n=0;p < g.length;p++) {
                ...
                if ("horizontal"===this.orientation) {
                    l.textBlock = new J(this.ctx, {x:0,y:0,maxWidth:e,maxHeight:this.lineHeight,angle:0,text:l.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"top"});
                    l.textBlock.measureText();
                    if (!k || k.width + l.textBlock.width + (0===k.width?0:this.horizontalSpacing) > e)
                        k={items:[],width:0},h.push(k),this.height=h.length *
                                                                   (l.textBlock.height + 5);
                    l.textBlock.x = k.width;
                    l.textBlock.y = 0;
                    k.width+=Math.round(l.textBlock.width + l.textBlock._lineHeight + (0===k.width?0:0.5 * l.textBlock._lineHeight))
                }
                else
                    this.height + this.lineHeight < f?(k={items:[],width:0},h.push(k),this.height=h.length * this.lineHeight):(k=h[n],n=(n + 1) % h.length),l.textBlock=new J(this.ctx, {
                                                                                                                                                                                  x:0,y:0,maxWidth:e,maxHeight:1.5 * this.fontSize,angle:0,text:l.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
                                                                                                                                                                                  fontStyle:this.fontStyle,textBaseline:"top"
                                                                                                                                                                              }),l.textBlock.measureText(),l.textBlock.x=k.width,l.textBlock.y=0,k.width+=l.textBlock.width + l.textBlock._lineHeight + (0===k.width?0:0.5 * l.textBlock._lineHeight);
                k.items.push(l);
                this.width = Math.max(k.width, this.width)
            }
            this.height = h.length * this.lineHeight
        }
        "top"===this.verticalAlign?(d="left"===this.horizontalAlign?a.x1 + 2:"right"===this.horizontalAlign?a.x2 - this.width - 2:a.x1 + a.width / 2 - this.width / 2,c=a.y1):"center"===this.verticalAlign?(d="left"===this.horizontalAlign?
                                                                                                                                                                                                               a.x1 + 2:"right"===this.horizontalAlign?a.x2 - this.width - 2:a.x1 + a.width / 2 - this.width / 2,c=a.y1 + a.height / 2 - this.height / 2):"bottom"===this.verticalAlign && (d="left"===this.horizontalAlign?a.x1 + 2:"right"===this.horizontalAlign?a.x2 - this.width - 2:a.x1 + a.width / 2 - this.width / 2,c=a.y2 - this.height - 5);
        this.items = g;
        for (p=0;p < this.items.length;p++)
            l=g[p],l.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[l.id]={
                id:l.id,objectType:"legendItem",legendItemIndex:p,dataSeriesIndex:l.dataSeriesIndex,
                dataPointIndex:l.dataPointIndex
            };
        for (p=0;p < h.length;p++)
            for (k=h[p],a=0;a < k.items.length;a++) {
                l = k.items[a];
                ...
                if ("line"===l.chartType || "stepLine"===l.chartType || "spline"===l.chartType)
                    this.ctx.strokeStyle=l.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight / 8),this.ctx.beginPath(),this.ctx.moveTo(f - 0.1 * this.lineHeight, g + this.lineHeight /
                                                                                                                                                                           2),this.ctx.lineTo(f + 0.7 * this.lineHeight, g + this.lineHeight / 2),this.ctx.stroke(),e-=0.1 * this.lineHeight;
                ...
                this.ghostCtx.fillRect(e, l.textBlock.y, l.textBlock.x + l.textBlock.width - e,
                                       l.textBlock.height);
    ...
    Q.prototype.getDataPointAtX = function(a, b) {
        if (!this.dataPoints || 0===this.dataPoints.length)
            return null;
        var c = {dataPoint:null,distance:Infinity,index:NaN}, d = null, e = 0, f = 0, g = 1, h = Infinity, p = 0, k = 0, l = 0;
    ...
    Q.prototype.getDataPointAtXY = function(a, b, c) {
        if (!this.dataPoints || 0===this.dataPoints.length)
            return null;
        c = c || !1;
        var d = [], e = 0, f = 0, g = 1, h = !1, p = Infinity, k = 0, l = 0, r = 0;
        ...
        for (;;) {
            ...
            if (0 <= f && f < this.dataPoints.length) {
                var m =
                    this.chart._eventManager.objectMap[this.dataPointIds[f]], q = this.dataPoints[f], n = null;
                if (m) {
                    switch (this.type) {
                        case "column":
                        case "stackedColumn":
                        ...
                        case "rangeColumn":
                        case "rangeBar":
                            a >= m.x1 && (a <= m.x2 && b >= m.y1 && b <= m.y2)&&(d.push({dataPoint:q,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(m.x1 - a), Math.abs(m.x2 - a), Math.abs(m.y1 - b), Math.abs(m.y2 - b))}),h=!0);
                            break;
                        case "line":
                        case "stepLine":
                        case "spline":
                        ...
                        case "scatter":
                            var s =
                                T("markerSize", q, this) || 4, t = c?20:s, n = Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y1 - b, 2));
                        ...
                        case "bubble":
                            ...
                            n <= s / 2&&(d.push({dataPoint:q,dataPointIndex:f,dataSeries:this,distance:n}),h=!0);
                            break;
                        case "pie":
                        case "doughnut":
                            s = m.center;
                            ...
                            n < m.radius && n > t&&(n=Math.atan2(b - s.y, a - s.x),0 > n && (n+=2 * Math.PI),n=Number(((180 * (n / Math.PI) % 360 + 360) % 360).toFixed(12)),s=Number(((180 * (m.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                            t=Number(((180 * (m.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),0===t && 1 < m.endAngle && (t=360),s >= t && 0!==q.y && (t+=360,n < s && (n+=360)),n > s && n < t && (d.push({dataPoint:q,dataPointIndex:f,dataSeries:this,distance:0}),h=!0));
                            break;
                        case "candlestick":
                            if (a >= m.x1 - m.borderThickness / 2 && a <= m.x2 + m.borderThickness / 2 && b >= m.y2 - m.borderThickness / 2 && b <= m.y3 + m.borderThickness / 2 || Math.abs(m.x2 - a + m.x1 - a) < m.borderThickness && b >= m.y1 && b <= m.y4)
                                d.push({
                                           dataPoint:q,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(m.x1 -
                                                                                                                   a), Math.abs(m.x2 - a), Math.abs(m.y2 - b), Math.abs(m.y3 - b))
                                       }),h=!0;
                            break;
                        case "ohlc":
                            if (Math.abs(m.x2 - a + m.x1 - a) < m.borderThickness && b >= m.y2 && b <= m.y3 || a >= m.x1 && a <= (m.x2 + m.x1) / 2 && b >= m.y1 - m.borderThickness / 2 && b <= m.y1 + m.borderThickness / 2 || a >= (m.x1 + m.x2) / 2 && a <= m.x2 && b >= m.y4 - m.borderThickness / 2 && b <= m.y4 + m.borderThickness / 2)
                                d.push({dataPoint:q,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(m.x1 - a), Math.abs(m.x2 - a), Math.abs(m.y2 - b), Math.abs(m.y3 - b))}),h=!0
                    }
                    if (h || 1E3 < k && 1E3 < l)
                        break
                }
    ...
    z.prototype.createLabels = function() {
        ...
        if ("bottom"===this._position || "top"===this._position)
            b=this.lineCoordinates.width / Math.abs(this.maximum - this.minimum) * this.interval,d=this.labelAutoFit?"undefined"===typeof this._options.labelMaxWidth?0.9 * b >> 0:this.labelMaxWidth:
                                                                                                   "undefined"===typeof this._options.labelMaxWidth?0.7 * this.chart.width >> 0:this.labelMaxWidth,e="undefined"===typeof this._options.labelWrap || this.labelWrap?0.5 * this.chart.height >> 0:1.5 * this.labelFontSize;
        else if ("left"===this._position || "right"===this._position)
            b=this.lineCoordinates.height / Math.abs(this.maximum - this.minimum) * this.interval,d=this.labelAutoFit?"undefined"===typeof this._options.labelMaxWidth?0.3 * this.chart.width >> 0:this.labelMaxWidth:"undefined"===typeof this._options.labelMaxWidth?
                                                                                                                                                                                                                                           0.5 * this.chart.width >> 0:this.labelMaxWidth,e="undefined"===typeof this._options.labelWrap || this.labelWrap?2 * b >> 0:1.5 * this.labelFontSize;
        if ("axisX"===this.type && "dateTime"===this.chart.plotInfo.axisXValueType)
            for (c=qa(new Date(this.maximum), this.interval, this.intervalType),b=this.intervalstartTimePercent;b < c;qa(b, this.interval, this.intervalType))
                a=b.getTime(),a="axisX"===this.type && this.labels[a]?this.labels[a]:ya(b, this.valueFormatString, this.chart._cultureInfo),a=new J(this.ctx, {
                                                                                                                                                        x:0,y:0,maxWidth:d,
            ...
            for (b=this.intervalstartTimePercent;b <= c;b=parseFloat((b + this.interval).toFixed(14)))
                a="axisX"===this.type && this.labels[b]?this.labels[b]:X(b, this.valueFormatString, this.chart._cultureInfo),a=new J(this.ctx, {
                                                                                                                                         x:0,y:0,maxWidth:d,maxHeight:e,angle:this.labelAngle,text:this.prefix + a + this.suffix,horizontalAlign:"left",fontSize:this.labelFontSize,fontFamily:this.labelFontFamily,fontWeight:this.labelFontWeight,fontColor:this.labelFontColor,
    ...
    z.setLayoutAndRender = function(a, b, c, d, e) {
        ...
        if (b && c && "undefined"===typeof b._options.maximum && "undefined"===typeof b._options.minimum && "undefined"===typeof b._options.interval && "undefined"===typeof c._options.maximum && "undefined"===
                                                                                                                                                                                                   typeof c._options.minimum && "undefined"===typeof c._options.interval) {
        ...
        if ("normal"===d) {
            ...
            b&&(f=Math.round(e.x1 + b.margin),d=Math.round(10 > e.y1?10:e.y1),g=Math.round(e.x1 + r + b.margin),h=Math.round(e.y2 - m - a.margin),b.lineCoordinates={x1:g,y1:d,x2:g,y2:h,height:Math.abs(h - d)},b.boundingRect={x1:f,y1:d,x2:g,y2:h,width:g - f,height:h - d});
            c&&(f=
                Math.round(a.lineCoordinates.x2),d=Math.round(10 > e.y1?10:e.y1),g=Math.round(f + l + c.margin),h=Math.round(e.y2 - m - a.margin),c.lineCoordinates={x1:f,y1:d,x2:f,y2:h,height:Math.abs(h - d)},c.boundingRect={x1:f,y1:d,x2:g,y2:h,width:g - f,height:h - d});
            ...
            c&&(c.lineCoordinates={},f=Math.round(e.x1 + r + a.margin),g=Math.round(e.x2 > c.chart.width - 10?c.chart.width - 10:e.x2),c.lineCoordinates.x1=f,c.lineCoordinates.x2=g,c.lineCoordinates.width=Math.abs(g -
                                                                                                                                                                                                                      f));
            var m = Math.ceil(b?b.createLabelsAndCalculateHeight():0), q = Math.ceil(c?c.createLabelsAndCalculateHeight():0);
            b&&(d=Math.round(e.y2 - m - b.margin),h=Math.round(e.y2 - l > b.chart.height - 10?b.chart.height - 10:e.y2 - l),b.lineCoordinates.y1=d,b.lineCoordinates.y2=d,b.boundingRect={x1:f,y1:d,x2:g,y2:h,width:g - f,height:m});
            c&&(d=Math.round(e.y1 + c.margin),h=e.y1 + c.margin + q,c.lineCoordinates.y1=h,c.lineCoordinates.y2=h,c.boundingRect={x1:f,y1:d,x2:g,y2:h,width:g - f,height:q});
            f = Math.round(e.x1 + a.margin);
            d = Math.round(c?
                           c.lineCoordinates.y2:10 > e.y1?10:e.y1);
    ...
    z.prototype.renderLabelsTicksAndTitle = function() {
        ...
        if ("bottom"===this._position) {
            ...
            this.title&&(this._titleTextBlock=new J(this.ctx, {
                                                        x:this.lineCoordinates.x1,y:this.boundingRect.y2 - this.titleFontSize - 5,maxWidth:this.lineCoordinates.width,maxHeight:1.5 *
                                                                                                                                                                                this.titleFontSize,angle:0,text:this.title,horizontalAlign:"center",fontSize:this.titleFontSize,fontFamily:this.titleFontFamily,fontWeight:this.titleFontWeight,fontColor:this.titleFontColor,fontStyle:this.titleFontStyle,textBaseline:"top"
            ...
            for (e=0;e < this._labels.length;e++)
                if (f=this._labels[e],!(f.position < this.minimum || f.position > this.maximum)) {
                    ...
                    if (!a || 0===d++ % 2 || this._labels[e].stripLine)
                        0===f.textBlock.angle?(b.x-=f.textBlock.width / 2,b.y-=this.tickLength + f.textBlock.height / 2):(b.x-=0 < this.labelAngle?f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle):0,b.y-=this.tickLength + Math.abs(0 < this.labelAngle?f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5:5)),f.textBlock.x=b.x,f.textBlock.y=b.y,f.textBlock.render(!0)
                }
            this.title&&
            (this._titleTextBlock=new J(this.ctx, {x:this.lineCoordinates.x1,y:this.boundingRect.y1 + 1,maxWidth:this.lineCoordinates.width,maxHeight:1.5 * this.titleFontSize,angle:0,text:this.title,horizontalAlign:"center",fontSize:this.titleFontSize,fontFamily:this.titleFontFamily,fontWeight:this.titleFontWeight,fontColor:this.titleFontColor,fontStyle:this.titleFontStyle,textBaseline:"top"}),this._titleTextBlock.measureText(),this._titleTextBlock.x=this.lineCoordinates.x1 + this.lineCoordinates.width / 2 - this._titleTextBlock.width /
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  2,this._titleTextBlock.render(!0))
        }
            ...
            for (e=0;e < this._labels.length;e++)
                if (f=this._labels[e],!(f.position < this.minimum || f.position > this.maximum)) {
                    b = this.getPixelCoordinatesOnAxis(f.position);
                    if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel"===this._labels[e].stripLine._thicknessType)
                        this._labels[e].stripLine?(c=this._labels[e].stripLine,this.ctx.lineWidth=c.thickness,this.ctx.strokeStyle=c.color):(this.ctx.lineWidth=this.tickThickness,
                    ...
                    if (!a || 0===d++ % 2 || this._labels[e].stripLine)
                        f.textBlock.x=b.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5,f.textBlock.y=0===this.labelAngle?b.y - f.textBlock.height / 2 + this.labelFontSize / 2:b.y - f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),f.textBlock.render(!0)
                }
            this.title&&
    ...
    z.prototype.renderInterlacedColors = function() {
        ...
        if (("bottom"===this._position || "top"===this._position) && this.interlacedColor)
            for (a.fillStyle=this.interlacedColor,e=0;e < this._labels.length;e++)
                this._labels[e].stripLine||(b?(b=this.getPixelCoordinatesOnAxis(this._labels[e].position),c=e + 1 >= this._labels.length?this.getPixelCoordinatesOnAxis(this.maximum):this.getPixelCoordinatesOnAxis(this._labels[e + 1].position),a.fillRect(b.x, d.y1, Math.abs(c.x - b.x), Math.abs(d.y1 - d.y2)),b=!1):b=!0);
        else if (("left"===this._position ||
                  "right"===this._position) && this.interlacedColor)
            for (a.fillStyle=this.interlacedColor,e=0;e < this._labels.length;e++)
                this._labels[e].stripLine||(b?(c=this.getPixelCoordinatesOnAxis(this._labels[e].position),b=e + 1 >= this._labels.length?this.getPixelCoordinatesOnAxis(this.maximum):this.getPixelCoordinatesOnAxis(this._labels[e + 1].position),a.fillRect(d.x1, b.y, Math.abs(d.x1 - d.x2), Math.abs(b.y - c.y)),b=!1):b=!0);
        a.beginPath()
    };
            ...
            for (var b = this.chart.plotArea.ctx, c = 0, c = 0;c < this.stripLines.length;c++) {
                ...
                if (d._thicknessType===a && ("pixel"!==a || !(d.value < this.minimum || d.value > this.maximum))) {
                    ...
                    if (!(0 >= f)) {
                        ...
                        b.lineWidth = f;
                        if ("bottom"===this._position || "top"===this._position)
                            g=h=1===b.lineWidth % 2?(e.x << 0) + 0.5:e.x << 0,p=this.chart.plotArea.y1,
                            k=this.chart.plotArea.y2;
                        else if ("left"===this._position || "right"===this._position)
                            p=k=1===b.lineWidth % 2?(e.y << 0) + 0.5:e.y << 0,g=this.chart.plotArea.x1,h=this.chart.plotArea.x2;
                        b.moveTo(g, p);
                        b.lineTo(h, k);
                        b.stroke()
                    }
        ...
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom"===this._position || "top"===this._position)
                ...
                for (var d = 0;d < this._labels.length && !this._labels[d].stripLine;d++)
                    this._labels[d].position < this.minimum || this._labels[d].position > this.maximum||(a.beginPath(),b=this.getPixelCoordinatesOnAxis(this._labels[d].position),b=1===
    ...
    z.prototype.calculateAxisParameters = function() {
        ...
        var a = "axisX"===this.type?500 > this.maxWidth?8:Math.max(6,
                                                                   Math.floor(this.maxWidth / 62)):Math.max(Math.floor(this.maxWidth / 40), 2), b, c, d, e;
        e = 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   this.intervalType="month"):e / (3 * B.monthDuration) <= a?(this.interval=3,this.intervalType="month"):e / (6 * B.monthDuration) <= a?(this.interval=6,this.intervalType="month"):(this.interval=e / (1 * B.yearDuration) <= a?1:e / (2 * B.yearDuration) <= a?2:e / (4 * B.yearDuration) <= a?4:Math.floor(z.getNiceNumber(e / (a - 1), !0) / B.yearDuration),this.intervalType="year")),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:b - d / 2,this.maximum=this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   c + d / 2,this.valueFormatString || ("year"===this.intervalType?this.valueFormatString="YYYY":"month"===this.intervalType?this.valueFormatString="MMM YYYY":"week"===this.intervalType?this.valueFormatString="MMM DD YYYY":"day"===this.intervalType?this.valueFormatString="MMM DD YYYY":"hour"===this.intervalType?this.valueFormatString="hh:mm TT":"minute"===this.intervalType?this.valueFormatString="hh:mm TT":"second"===this.intervalType?this.valueFormatString="hh:mm:ss TT":"millisecond"===this.intervalType &&
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            (this.valueFormatString="fff'ms'")),this.intervalstartTimePercent=this.getLabelStartPoint(new Date(this.minimum), this.intervalType, this.interval)):(this.intervalType="number",e=z.getNiceNumber(c - b, !1),this.interval=this._options && this._options.interval?this._options.interval:z.getNiceNumber(e / (a - 1), !0),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:Math.floor(b / this.interval) * this.interval,this.maximum=null!==this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Math.ceil(c / this.interval) * this.interval,"axisX"===this.type?(null===this.sessionVariables.internalMinimum && (this.minimum=b - d / 2),this.sessionVariables.internalMaximum || (this.maximum=c + d / 2),this.intervalstartTimePercent=Math.floor((this.minimum + 0.2 * this.interval) / this.interval) * this.interval):"axisY"===this.type && (this.intervalstartTimePercent=this.minimum));
        "axisX"===this.type&&(this._absoluteMinimum=this._options && "undefined"!==typeof this._options.minimum?this._options.minimum:this.dataInfo.min -
                                                                                                                                      d / 2,this._absoluteMaximum=this._options && "undefined"!==typeof this._options.maximum?this._options.maximum:this.dataInfo.max + d / 2);
    ...
    z.getNiceNumber = function(a, b) {
        ...
        return Number(((b?1.5 > d?1:3 > d?2:7 > d?5:10:1 >= d?1:2 >= d?2:5 >= d?5:10) * Math.pow(10,
                                                                                                 c)).toFixed(20))
    };
    ...
    O.prototype._updateToolTip = function(a, b) {
        if (this.enabled && !this.chart.disableToolTip) {
            ...
            if (this.shared && "none"!==this.chart.plotInfo.axisPlacement) {
                ...
                else if ("line"===d.type || "stepLine"===d.type || "spline"===d.type || "area"===d.type || "stepArea"===d.type || "splineArea"===
                                                                                                                                  d.type || "stackedArea"===d.type || "stackedArea100"===d.type || "rangeArea"===d.type || "rangeSplineArea"===d.type || "candlestick"===d.type || "ohlc"===d.type)
            ...
            if (0 < e.length)
                if (this.highlightObjects(e),f="",f=this.getToolTipInnerHTML({entries:e}),
                null!==f) {
                    ...
                    toolTipLeft+="px";
                    e = 1!==e.length || this.shared || "line"!==e[0].dataSeries.type && "stepLine"!==e[0].dataSeries.type && "spline"!==e[0].dataSeries.type && "area"!==e[0].dataSeries.type && "stepArea"!==e[0].dataSeries.type && "splineArea"!==e[0].dataSeries.type && "stackedArea"!==e[0].dataSeries.type && "stackedArea100"!==
        ...
        if (this.enabled) {
            ...
            for (var d = 0, c = 0;c < a.length;c++) {
                ...
                if ((e=this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint"===e.objectType) {
                    ...
                    if ("line"===d.type || "stepLine"===d.type || "spline"===d.type || "scatter"===d.type || "area"===d.type || "stepArea"===d.type || "splineArea"===d.type || "stackedArea"===d.type || "stackedArea100"===d.type || "rangeArea"===d.type || "rangeSplineArea"===
                                                                                                                                                                                                                                                               d.type) {
                        ...
                        K.drawMarkers([g]);
                        "undefined"!==typeof e.y2 && (g=d.getMarkerProperties(f, e.x1, e.y2, this.chart.overlaidCanvasCtx),g.size=Math.max(1.5 * g.size << 0, 10),g.borderColor=g.borderColor || "#FFFFFF",g.borderThickness=g.borderThickness || Math.ceil(0.1 * g.size),K.drawMarkers([g]))
                    }
                    else
                        "bubble"===d.type?(g=d.getMarkerProperties(f,
                                                                   e.x1, e.y1, this.chart.overlaidCanvasCtx),g.size=e.size,g.color="white",g.borderColor="white",b.globalAlpha=0.3,K.drawMarkers([g]),b.globalAlpha=1):"column"===d.type || "stackedColumn"===d.type || "stackedColumn100"===d.type || "bar"===d.type || "rangeBar"===d.type || "stackedBar"===d.type || "stackedBar100"===d.type || "rangeColumn"===d.type?G(b, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3):"pie"===d.type || "doughnut"===d.type?pa(b, e.center, e.radius, "white", d.type, e.startAngle, e.endAngle, 0.3):"candlestick"===
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                d.type?(b.globalAlpha=1,b.strokeStyle=e.color,b.lineWidth=2 * e.borderThickness,d=0===b.lineWidth % 2?0:0.5,b.beginPath(),b.moveTo(e.x3 - d, e.y2),b.lineTo(e.x3 - d, Math.min(e.y1, e.y4)),b.stroke(),b.beginPath(),b.moveTo(e.x3 - d, Math.max(e.y1, e.y4)),b.lineTo(e.x3 - d, e.y3),b.stroke(),G(b, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),b.globalAlpha=1):"ohlc"===d.type && (b.globalAlpha=1,b.strokeStyle=e.color,b.lineWidth=2 * e.borderThickness,d=0===b.lineWidth %
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 2?0:0.5,b.beginPath(),b.moveTo(e.x3 - d, e.y2),b.lineTo(e.x3 - d, e.y3),b.stroke(),b.beginPath(),b.moveTo(e.x3, e.y1),b.lineTo(e.x1, e.y1),b.stroke(),b.beginPath(),b.moveTo(e.x3, e.y4),b.lineTo(e.x2, e.y4),b.stroke(),b.globalAlpha=1)
                }
            }
            b.globalAlpha = 1;
            b.restore()
    ...
    O.prototype.getToolTipInnerHTML = function(a) {
        ...
        if (g && this.content && "function"===typeof this.content)
            b =
            this.content({entries:a});
        else if (this.shared) {
            for (var p = "", h = 0;h < a.length;h++)
                if (c=a[h].dataSeries,d=a[h].dataPoint,e=a[h].index,f="",0===h && (g && !this.content) && (p+="undefined"!==typeof this.chart.axisX.labels[d.x]?this.chart.axisX.labels[d.x]:"{x}",p+="</br>",p=this.chart.replaceKeywordsWithValue(p, d, c, e)),null!==d.toolTipContent && ("undefined"!==typeof d.toolTipContent || null!==c._options.toolTipContent)) {
                    if ("line"===c.type || "stepLine"===c.type || "spline"===c.type || "area"===c.type || "stepArea"===c.type ||
                        "splineArea"===c.type || "column"===c.type || "bar"===c.type || "scatter"===c.type || "stackedColumn"===c.type || "stackedColumn100"===c.type || "stackedBar"===c.type || "stackedBar100"===c.type || "stackedArea"===c.type || "stackedArea100"===c.type)
                        ...
                        f+=d.toolTipContent?d.toolTipContent:c.toolTipContent?
                                                             c.toolTipContent:this.content && "function"!==typeof this.content?this.content:"<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
                        ...
                        f+=d.toolTipContent?d.toolTipContent:
                           c.toolTipContent?c.toolTipContent:this.content && "function"!==typeof this.content?this.content:"<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
    ...
    v.prototype.replaceKeywordsWithValue = function(a, b, c, d, e) {
        ...
        if ((0 <= c.type.indexOf("stacked") || "pie"===c.type ||
            ...
            if (0 <= c.type.indexOf("stacked"))
                h=0,p=b.x.getTime?b.x.getTime():b.x,p in c.plotUnit.yTotals && (h=c.plotUnit.yTotals[p],g=isNaN(b.y)?0:100 * (b.y / h));
            else if ("pie"===c.type || "doughnut"===c.type) {
                for (i=h=0;i < c.dataPoints.length;i++)
                    isNaN(c.dataPoints[i].y)||(h+=c.dataPoints[i].y);
            ...
            do {
                ...
                if (c.percentFormatString)
                    ...
                    var p = "#,##0.", k = Math.max(Math.ceil(Math.log(1 /
    ...
    var y = {
        yScaleAnimation:function(a, b) {
            ...
            if (0!==a) {
                ...
                c.save();
                0 < a&&c.drawImage(d, 0, 0, d.width * a, d.height, 0, 0, d.width * a / I, d.height /
                                                                                          I);
                c.restore()
            }
