function SignatureCapture( canvasID, signatureType ) {
    ...
    var perc = (0.1 * (app.deviceInfo.deviceWidth()));
	this.canvas[0].width = (app.deviceInfo.deviceWidth()) - perc;
...
SignatureCapture.prototype.updateCanvas = function (event) {
    ...
    //console.log("X1: " + this.lastMousePoint.x + " Y1:" + this.lastMousePoint.y)
	this.updateMousePosition( event );
	this.context.lineTo( this.lastMousePoint.x, this.lastMousePoint.y );
    //console.log("X2: " + this.lastMousePoint.x + " Y2:" + this.lastMousePoint.y)
	this.context.stroke();
}
...
SignatureCapture.prototype.toBase64 = function () {
